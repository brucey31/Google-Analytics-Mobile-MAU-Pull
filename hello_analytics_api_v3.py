...
with open('Adwords_costs.csv', 'wb',) as fp:
    ...
    while start_date<= end_date:
        ...
        def get_top_keywords(service, profile_id):
          ...
          return service.data().ga().get(
              ...
              dimensions='ga:date,ga:adGroup,ga:campaign').execute()
...
subprocess.call({"ls"})
#subprocess.call({"s3cmd", "put", "Adwords_costs.csv", "s3://bibusuu/Adwords_Costs/Adwords_Costs.csv"})
#subprocess.call({"s3cmd", "ls", "s3://bibusuu/Adwords_Costs/"})